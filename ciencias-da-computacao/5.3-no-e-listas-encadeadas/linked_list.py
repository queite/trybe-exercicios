...
class LinkedList:
    ...
    def is_empty(self):
        return not self.__length  # retorna True se o len for 0
...
if __name__ == "__main__":
    ...
    print(
        linked_list
    )  # saída: LinkedList(len=2 value=Node(value=2 next=Node(value=1 next=None))) # noqa

    linked_list.insert_last(3)
    print(
        linked_list
    )  # saída: LinkedList(len=3 value=Node(value=2 next=Node(value=1 next=Node(value=3 next=None)))) # noqa
    ...
    print(
        linked_list
    )  # saída: LinkedList(len=2 value=Node(value=1 next=Node(value=5 next=None))) # noqa
